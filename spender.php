...
$allowed_pages = ['dashboard', 'manage_groups', 'manage_expenses', 'manage_payments', 'scheduler', 'manage_reminders', 'notifications', 'my_account', 'split_expense', 'view_split_expense', 'friends', 'archive'];
...
<html>
<head>
  <title>Spender Page</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"/>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
  <style>
    /* ===== BASIC RESET ===== */
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', Arial, sans-serif; }
    body { background: #fcfcfc; min-height: 100vh; }
    .app { display: flex; min-height: 100vh; }

    /* ===== SIDEBAR (FIXED - NO HOVER) ===== */
    .sidebar {
      width: 200px; /* Fixed professional width */
      background: white; 
      padding: 10px 0; 
      display: flex; 
    ...
    .left-nav h3 { font-size: 20px; font-weight: 700; color: #222; opacity: 1; }
    ...
    .profile-menu a {
      ...
      text-decoration: none; font-size: 14px; color: #374151; border-radius: 8px; transition: 0.2s;
    }
    ...
    .content-header { padding: 30px 30px 10px 30px; display: flex; justify-content: space-between; align-items: center; }
