...
if (isset($_POST['mark_paid'])) {
    $person_id = $_POST['person_id']; // The ID from the 'people' table
    $target_expense_id = $_POST['expense_id'];

    // Updated to use your new people_id column
...
// 2. Determine which expense to display (from URL or the latest one)
...
// 4. Fetch participants by joining with your 'people' table
$stmt = $conn->prepare("
...
<head>
    ...
    <style>
        ...
        .selector {
            ...
            font-weight: 600; font-family: inherit; cursor: pointer; margin-bottom: 24px;
        }
    ...
    <div class="split-container">
        ...
        <div class="right-col">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td style="font-weight: 600;">You</td>
                        <?php 
                            // Your share calculation: Total / (Selected People + 1)
                            $your_share = $expense['amount'] / (count($participants) + 1);
                        ?>
                        <td>₱<?= number_format($your_share, 2) ?></td>
